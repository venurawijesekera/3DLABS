...
const galleryItems: GalleryItem[] = [
    { id: 1, title: 'Carbon Fiber Nylon with PLA infill', category: 'FDM', image: '/assets/img/gallery/1.webp' },
    { id: 2, title: 'Replacement Part For ZEISS Humphry Field Analyzer', category: 'SLA', image: '/assets/img/gallery/2.webp' },
    { id: 3, title: 'Electronics Enclosure Printed With ASA', category: 'FDM', image: '/assets/img/gallery/3.webp' },
    { id: 4, title: 'Electronics Enclosure Printed With ASA', category: 'FDM', image: '/assets/img/gallery/4.webp' },
    { id: 5, title: 'Industrial Cooling Fan For CEYPETCO Using PA6 CF', category: 'FDM', image: '/assets/img/gallery/5.webp' },
    { id: 6, title: 'Multi Material Print ABS-CF/PLA/TPU Caster Wheel', category: 'FDM', image: '/assets/img/gallery/6.webp' },
    { id: 7, title: 'Centrifuge Rotor Printed Using PETG CF', category: 'FDM', image: '/assets/img/gallery/7.webp' },
    { id: 8, title: 'Clear Resin Printed Mount', category: 'SLA', image: '/assets/img/gallery/8.webp' },
    { id: 9, title: 'Hight Temp. Resin - Espresso Coffee Maker Presure Guage', category: 'SLA', image: '/assets/img/gallery/9.webp' },
    { id: 10, title: 'Airless Tire', category: 'FDM', image: '/assets/img/gallery/10.webp' },
    { id: 11, title: 'Airless Tire with ABS Rim', category: 'FDM', image: '/assets/img/gallery/11.webp' },
    { id: 12, title: 'Medical Device Enclosure Replacement', category: 'SLA', image: '/assets/img/gallery/12.webp' },
    { id: 13, title: 'Clear Specs Frame', category: 'SLA', image: '/assets/img/gallery/13.webp' },
    { id: 14, title: 'Custom Specs Frame', category: 'SLA', image: '/assets/img/gallery/14.webp' },
    { id: 15, title: 'Multi Material Gear Wheel PETG-CF with PLA infill', category: 'FDM', image: '/assets/img/gallery/15.webp' },
    { id: 16, title: 'Blower Impeller', category: 'SLA', image: '/assets/img/gallery/16.webp' },
    { id: 17, title: 'Mini Gear Wheel', category: 'SLA', image: '/assets/img/gallery/17.webp' },
    { id: 18, title: 'Cosplay Helmet printed with PLA', category: 'FDM', image: '/assets/img/gallery/18.webp' },
];
