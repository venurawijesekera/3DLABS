...
const materials = [
    {
        ...
        image: '/assets/img/3d-labs/Planter842x450.png',
        tag: 'PLA',
    ...
    },
    {
        ...
        image: '/assets/img/material/petg.png',
        tag: 'PETG',
    ...
    },
    {
        ...
        image: '/assets/img/material/petgcf.png',
        tag: 'PETG CF',
    ...
    },
    {
        ...
        image: '/assets/img/material/abs.png',
        tag: 'ABS',
    ...
    },
    {
        ...
        image: '/assets/img/material/abscf.png',
        tag: 'ABS CF',
    ...
    },
    {
        ...
        image: '/assets/img/material/ABS-FR.png',
    ...
    },
    {
        ...
        image: '/assets/img/material/tpu.png',
        tag: 'TPU 95a',
    ...
    },
    {
        ...
        image: '/assets/img/material/tpe.png',
        tag: 'TPE 85a',
    ...
    },
    {
        ...
        image: '/assets/img/material/pa6-brkt.png',
        tag: 'PA6 (NYLON)',
    ...
    },
    {
        ...
        image: '/assets/img/material/pa6.png',
        tag: 'PA12 (NYLON)',
        description: 'PA6 (Nylon 6) and PA12 (Nylon 12) are both strong and durable engineering plastics, but they differ in flexibility, moisture absorption, and chemical resistance. PA6 offers higher strength, stiffness, and heat resistance, making it suitable for load-bearing and structural parts. However, it absorbs more moisture, which can affect dimensional stability. In contrast, PA12 is more flexible, has lower water absorption, and provides excellent impact and chemical resistance, making it ideal for parts exposed to varying environmental conditions such as hoses, fittings, and flexible connectors.'
    },
    {
        ...
        image: '/assets/img/material/pa6cf.png',
        tag: 'PA6 CF (NYLON)',
    ...
    },
    {
        slug: 'pc',
        name: 'Polycarbonate',
        image: '/assets/img/material/pc.png',
        tag: 'PC',
    ...
    },
    {
        ...
        image: '/assets/img/material/pc-cf.png',
        tag: 'PC CF',
    ...
    },
    {
        ...
        image: '/assets/img/material/asa.png',
        tag: 'ASA',
                                ...
                                <div className="cs-sidebar_item">
                                    ...
                                    <ul className="cs-recent_posts">
                                        <li>
                                            <div className="cs-recent_post">
                                                <Link href="#" className="cs-recent_post_thumb">
                                                    <div className="cs-recent_post_thumb_in cs-bg" style={{ backgroundImage: "url('/assets/img/minilogo/FDM.png')" }}></div>
                                                </Link>
                                        ...
                                        <li>
                                            <div className="cs-recent_post">
                                                <Link href="#" className="cs-recent_post_thumb">
                                                    <div className="cs-recent_post_thumb_in cs-bg" style={{ backgroundImage: "url('/assets/img/minilogo/SLA.png')" }}></div>
                                                </Link>
                                                <div className="cs-recent_post_info">
                                                    <h3 className="cs-recent_post_title">
                                                        <Link href="#">SLA</Link>
